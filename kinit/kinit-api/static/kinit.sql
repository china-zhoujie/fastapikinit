...
CREATE TABLE `vadmin_auth_menu`  (
  ...
  `component` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '前端组件地址',
  `path` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '前端路由地址',
  `hidden` tinyint(1) NULL DEFAULT NULL COMMENT '是否显示',
  `menu_type` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '菜单类型',
...
CREATE TABLE `vadmin_auth_role`  (
  ...
  `role_key` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '权限字符',
...
CREATE TABLE `vadmin_auth_user`  (
  ...
  `last_ip` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '最后一次登录IP',
...
CREATE TABLE `vadmin_record_login`  (
  ...
  `ip` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '登陆地址',
  `address` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '登陆地点',
  ...
  `response` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '响应信息',
...
) ENGINE = InnoDB AUTO_INCREMENT = 174 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `vadmin_record_operation`  (
  ...
  `response` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '响应信息',
  `request` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '请求信息',
  `request_api` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '请求接口',
...
CREATE TABLE `vadmin_record_sms_send`  (
  ...
  `telephone` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '目标手机号',
  `desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '失败描述',
  `scene` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发送场景',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `vadmin_system_dict_details`  (
  ...
  `value` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '字典键值',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '字典详情表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `vadmin_system_dict_type`  (
  ...
  `dict_type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '字典类型',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `disabled` tinyint(1) NULL DEFAULT NULL COMMENT '字典状态，是否禁用',
  PRIMARY KEY (`id`) USING BTREE,
